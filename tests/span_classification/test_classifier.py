...
class TestClassifier(object):
    ...
    def _assert_trainable(self):
        ...
        trainer = SpanClassificationTrainer(self.model, optimizer=optimizer, device=self.device)
    ...
    def _setup_case(self, data, device):
        ...
        self.dataset = SpanClassificationDataset(data, self.config)
    ...
    def test_classifier(self, enc_arch, agg_mode, conll2004_demo, device):
        self.config = SpanClassifierConfig(intermediate2=EncoderConfig(arch=enc_arch), 
    ...
    def test_classifier_with_bert_like(self, conll2004_demo, bert_with_tokenizer, device):
        ...
        self.config = SpanClassifierConfig(ohots=None, 
