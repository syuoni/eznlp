...
def test_sequence_attention(scoring, nonlinearity):
    BATCH_SIZE = 100
    MAX_LEN = 20
    HID_DIM = 50
    ...
    atten_values, atten_weight = SequenceAttention(HID_DIM, scoring=scoring, nonlinearity=nonlinearity)(x, mask, return_atten_weight=True)
