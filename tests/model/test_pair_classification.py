...
class TestModel(object):
    ...
    def test_model(self, arch, agg_mode, ck_label_emb_dim, criterion, conll2004_demo, device):
        self.config = ModelConfig(intermediate2=EncoderConfig(arch=arch), 
                                  decoder=PairClassificationDecoderConfig(agg_mode=agg_mode, ck_label_emb_dim=ck_label_emb_dim, criterion=criterion))
