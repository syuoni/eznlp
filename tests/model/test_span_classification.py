...
class TestModel(object):
    ...
    def test_model(self, arch, agg_mode, size_emb_dim, criterion, conll2004_demo, device):
        self.config = ModelConfig(intermediate2=EncoderConfig(arch=arch), 
                                  decoder=SpanClassificationDecoderConfig(agg_mode=agg_mode, size_emb_dim=size_emb_dim, criterion=criterion))
