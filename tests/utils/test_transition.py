...
def test_tags2chunks(BIOES_tags_example):
    ...
    for chunk_type, chunk_start, chunk_end in chunks:
        assert all(
            tag.split("-")[1] == chunk_type for tag in tags[chunk_start:chunk_end]
        )
...
@pytest.mark.parametrize(
    ...
    [
        (
            "BIO1",
            ["I-EntA", "I-EntA", "I-EntA", "B-EntA", "B-EntB", "O", "I-EntC", "I-EntC"],
        ),
        (
            "BIO2",
            ["B-EntA", "I-EntA", "I-EntA", "B-EntA", "B-EntB", "O", "B-EntC", "I-EntC"],
        ),
        (
            "BIOES",
            ["B-EntA", "I-EntA", "E-EntA", "S-EntA", "S-EntB", "O", "B-EntC", "E-EntC"],
        ),
