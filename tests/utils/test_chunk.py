...
def test_tags2text_chunks(spacy_nlp_en):
    ...
    entities = [
        {"entity": "demo", "type": "EntA", "start": 16, "end": 20},
        {"entity": "APPLE", "type": "EntA", "start": 35, "end": 40},
        {"entity": "glass bottles", "type": "EntB", "start": 50, "end": 63},
    ]
    text_chunks = [
        (ent["type"], ent["start"], ent["end"], ent["entity"]) for ent in entities
    ]
    tags = [
        "O",
        "O",
    ...
    text_chunks_retr = text_translator.chunks2text_chunks(
        chunks, tokens, raw_text, append_chunk_text=True
    )
    ...
    for span in tokens.spans_within_max_length(10):
        ...
        curr_text_chunks = text_translator.chunks2text_chunks(
            curr_chunks, tokens[span], raw_text, append_chunk_text=True
        )
