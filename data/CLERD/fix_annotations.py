...
for file_path, offset, offset_start in [
    ("relation_extraction/Training/1122.txt", -1, 2603),
...
for file_path, drop_indexes in [
    ("relation_extraction/Training/1108.txt", [292]),
