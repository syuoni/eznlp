...
def parse_arguments(parser: argparse.ArgumentParser):
    ...
    group_data.add_argument('--dataset', type=str, default='HwaMei_500',
                            help="dataset name")
    ...
    group_decoder.add_argument('--attr_decoder', type=str, default='span_attr_classification',
                               help="attribute decoding method", choices=['span_attr_classification', 'masked_span_attr'])

    # Loss
    group_decoder.add_argument('--no_multilabel', dest='multilabel', default=True, action='store_false',
    ...
    group_decoder.add_argument('--check_ac_labels', default=False, action='store_true',
...
def build_AE_config(args: argparse.Namespace):
    ...
    if args.attr_decoder == 'span_attr_classification':
        decoder_config = SpanAttrClassificationDecoderConfig(size_emb_dim=args.size_emb_dim,
        ...
        decoder_config = MaskedSpanAttrClsDecoderConfig(size_emb_dim=args.size_emb_dim,
                                                        label_emb_dim=args.label_emb_dim,
                                                        reduction=reduction_config,
                                                        ck_loss_weight=args.ck_loss_weight,
                                                        check_ac_labels=args.check_ac_labels,
