...
def parse_arguments(parser: argparse.ArgumentParser):
    ...
    group_data.add_argument(
        "--dataset", type=str, default="flickr8k", help="dataset name"
    )
    ...
    group_decoder.add_argument(
        "--atten_scoring", type=str, default="biaffine", help="attention scoring"
    )
    group_decoder.add_argument(
        "--sin_positional_emb",
        default=False,
...
def collect_I2T_assembly_config(args: argparse.Namespace):
    ...
    return {"encoder": enc_config, "decoder": gen_config}
